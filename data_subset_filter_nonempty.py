...
def extract_601_900_non_empty_columns():
    input_file = 'Liste1.xls'  # oder .csv
    output_file = 'non_empty_601_900.xlsx'
    ...
    try:
        ...
        print(f"✅ Erfolg: Zeilen 601-900 mit nicht-leeren Spalten gespeichert")
